...
export const answerHistoriesDummy: AnswerHistoryDummyType[] = [
  ...
  },
  {
    ...
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 1, 23, 56),
  },
  {
    quizHistoryId: 1,
    questionId: 6,
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 0, 45, 23),
  },
  {
    quizHistoryId: 1,
    questionId: 7,
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 0, 23, 45),
  },
  {
    quizHistoryId: 1,
    questionId: 8,
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 0, 12, 34),
  },
  {
    quizHistoryId: 1,
    questionId: 9,
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 0, 7, 18),
  },
  {
    quizHistoryId: 1,
    questionId: 10,
    userAnswer: 2,
    correctness: 0,
    duration: new Date(0, 0, 0, 0, 0, 3, 45),
  },
  {
    quizHistoryId: 2,
    questionId: 11,
